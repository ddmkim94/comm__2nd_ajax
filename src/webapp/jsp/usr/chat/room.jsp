            ...
            .then(responseData => {
                ...
                for ( const index in messages ) {
                    ...
                    <li class="flex">
                        ...
                        <span>\${message.body}</a>
                        &nbsp;
                        <a onclick="if ( !confirm('정말로 삭제하시겠습니까?') ) return false;" class="hover:underline hover:text-[red] mr-2" href="/usr/chat/deleteMessageAjax/\${message.id}?_method=DELETE">삭제</a>
                    </li>
                `;
